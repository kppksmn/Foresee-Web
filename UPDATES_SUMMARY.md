...
### 1. เปิดให้กดดูรายละเอียดงาน (View Details) ได้เสมอ ไม่ว่าจะตั้งค่าสิทธิ์อย่างไร
...
### 2. เพิ่มปุ่มและระบบส่งออก Excel (.csv UTF-8 BOM) ในหน้าจัดการงานและงานของฉัน
...
### 3. เพิ่มหน้าจอ "งานของฉัน" (`/my-jobs`) พร้อมระบบกรองเลือกวันที่นัดหมาย
- `src/features/jobs/MyJobsPage.tsx`:
...
### 4. แก้ไขบั๊กการกดปิด Submenu ใน Sidebar 2 ครั้งหลัง Refresh หน้าจอ
...
### 5. บังคับใช้สิทธิ์ใช้งานในหน้าประเภทรถ (Vehicle Types Permission Enforcements)
- `src/features/vehicles/VehicleTypesPage.tsx`:
...
### 6. เพิ่มตัวเลือกกรองวันที่นัดหมายในงานปัจจุบัน และประวัติงาน (Scheduled Date Filter for Jobs)
- `src/features/jobs/JobsPage.tsx`:
...
### 8. ล็อกและป้องกันการเลือกคนขับที่ใบขับขี่หมดอายุ (Driver License Expiration UI Guard)
